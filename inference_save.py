...
def inference_on_dataset(
    ...
    with ExitStack() as stack:
        ...
        for idx, inputs in enumerate(data_loader):
            ...
            save_dir = "/22liushoulong/projects3/ovfoodD_simple/output/inference_save_outputs"
            os.makedirs(save_dir, exist_ok=True)
            input_file_path = inputs[0]['file_name']
            base_filename = os.path.splitext(os.path.basename(input_file_path))[0]
            output_file_path = os.path.join(save_dir, f"{base_filename}.pth")
            data_to_save = outputs[0]
            try:
